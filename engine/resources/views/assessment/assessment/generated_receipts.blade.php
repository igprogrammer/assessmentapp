...
@section('content')
    ...
    <script>
        ...
        function search_entity(){
            ...
            myObject.open('GET','{{ URL::route("search-assessment") }}?searchType='+searchType+'&reference='+reference+'&controlNumber='+controlNumber+'&flag='+flag+'&entityName='+entityName+'&entityNumber='+entityNumber,true);
            myObject.send();
        }
