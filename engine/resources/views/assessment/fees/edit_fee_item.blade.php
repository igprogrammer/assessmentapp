...
@section('content')
    ...
    <div style="border-bottom:none;padding-top:10px; padding-bottom:2px;background-color: white;margin-top: 10px;margin-left:3px;margin-right: 3px;margin-bottom: 0px" class="ask fbbluebox">
        ...
        {!! Form::open(['url'=>'fees/update-fee-item','method'=>'post','class'=>'form','files'=>true])!!}
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                            <div class="form-group {{$errors->has('questionTitle')?'has-error':''}}">
                                ...
                                {!! Form::select('fee_account_id',[''=>'Select account']+$feeAccounts,$fee->fee_account_id,['class'=>'form-control','id'=>'fee_account_id','onchange'=>'get_fees()']) !!}
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group {{$errors->has('questionTitle')?'has-error':''}}">
                                {!! Form::label('title','Fee') !!}
                                {!! Form::select('fee_id',[''=>'Select fee']+$fees,$feeItem->fee_id,['class'=>'form-control','id'=>'fee_id']) !!}
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group {{$errors->has('questionTitle')?'has-error':''}}">
                                {!! Form::label('title','Item name') !!}
                                {!! Form::text('item_name',$feeItem->item_name,['class'=>'form-control','placeholder'=>'Item name']) !!}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                            <div class="form-group {{$errors->has('questionTitle')?'has-error':''}}">
                                ...
                                {!! Form::text('item_amount',$feeItem->item_amount,['class'=>'form-control','placeholder'=>'Item amount']) !!}
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group {{$errors->has('questionTitle')?'has-error':''}}">
                                {!! Form::label('title','Penalty amount') !!}
                                {!! Form::text('penalty_amount',$feeItem->penalty_amount,['class'=>'form-control','placeholder'=>'Penalty amount','id'=>'penalty_amount']) !!}
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group {{$errors->has('questionTitle')?'has-error':''}}">
                                ...
                                {!! Form::text('days',$feeItem->days,['class'=>'form-control','placeholder'=>'Days before penalty']) !!}
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group {{$errors->has('questionTitle')?'has-error':''}}">
                                {!! Form::label('title','Copy charge') !!}
                                {!! Form::text('copy_charge',$feeItem->copy_charge,['class'=>'form-control','placeholder'=>'Copy charge']) !!}
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-3">
                            <div class="form-group {{$errors->has('questionTitle')?'has-error':''}}">
                                ...
                                {!! Form::text('stamp_duty_amount',$feeItem->stamp_duty_amount,['class'=>'form-control','placeholder'=>'Stamp duty amount']) !!}
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group {{$errors->has('questionTitle')?'has-error':''}}">
                                {!! Form::label('title','Currency') !!}
                                {!! Form::select('currency',[''=>'Select currency']+$currencies,$feeItem->currency,['class'=>'form-control']) !!}
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group {{$errors->has('questionTitle')?'has-error':''}}">
                                {!! Form::label('title','Define fee amount?') !!}
                                {!! Form::select('defineFeeAmount',[''=>'Select status','1'=>'Yes','0'=>'No'],$feeItem->defineFeeAmount,['class'=>'form-control','required'=>'required']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="col-md-6">
                        <div class="form-group">
                            {!! Form::hidden('feeItemId',$feeItem->id) !!}
