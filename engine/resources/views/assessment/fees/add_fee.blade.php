...
@section('content')
    ...
    <div style="border-bottom:none;padding-top:10px; padding-bottom:2px;background-color: white;margin-top: 10px;margin-left:3px;margin-right: 3px;margin-bottom: 0px" class="ask fbbluebox">
        ...
        {!! Form::open(['route'=>'save-fee','method'=>'post','class'=>'form','files'=>true])!!}
                    ...
                    <div class="col-md-12">
                        <div class="col-md-3">
                            <div class="form-group {{$errors->has('questionTitle')?'has-error':''}}">
                                ...
                                {!! Form::select('fee_account_id',[''=>'Select account'],array(),['class'=>'form-control','id'=>'fee_account_id','onchange'=>'get_code()']) !!}
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group {{$errors->has('questionTitle')?'has-error':''}}">
                                {!! Form::label('title','Fee code') !!}
                                {!! Form::text('fee_code',null,['class'=>'form-control','placeholder'=>'Fee code']) !!}
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group {{$errors->has('questionTitle')?'has-error':''}}">
                                {!! Form::label('title','Fee name') !!}
                                {!! Form::text('fee_name',null,['class'=>'form-control','placeholder'=>'Fee name']) !!}
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group {{$errors->has('questionTitle')?'has-error':''}}">
                                {!! Form::label('title','Account code') !!}
                                {!! Form::text('account_code',null,['class'=>'form-control','placeholder'=>'Account code','id'=>'account_code','readonly']) !!}
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="col-md-3">
                                <div class="form-group {{$errors->has('questionTitle')?'has-error':''}}">
                                    ...
                                    {!! Form::select('type',[''=>'Select type','new'=>'New','change'=>'Change'],array(),['class'=>'form-control']) !!}
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group {{$errors->has('questionTitle')?'has-error':''}}">
                                    {!! Form::label('title','GFS code') !!}
                                    {!! Form::text('gfs_code',null,['class'=>'form-control','placeholder'=>'GFS code']) !!}
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group {{$errors->has('questionTitle')?'has-error':''}}">
                                    {!! Form::label('title','Has form') !!}
                                    {!! Form::select('has_form',[''=>'Select option','no'=>'No','yes'=>'Yes'],array(),['class'=>'form-control']) !!}
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group {{$errors->has('questionTitle')?'has-error':''}}">
