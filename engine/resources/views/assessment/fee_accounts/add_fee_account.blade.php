...
@section('content')
    ...
    <div style="border-bottom:none;padding-top:10px; padding-bottom:2px;background-color: white;margin-top: 10px;margin-left:3px;margin-right: 3px;margin-bottom: 0px" class="ask fbbluebox">
        ...
        {!! Form::open(['url'=>'fees/save-fee-account','method'=>'post','class'=>'form','files'=>true])!!}
                    ...
                    <div class="col-md-12">
                        <div class="col-md-3">
                            <div class="form-group {{$errors->has('questionTitle')?'has-error':''}}">
                                ...
                                {!! Form::select('division_id',[''=>'Select division']+$divisions,array(),['class'=>'form-control']) !!}
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group {{$errors->has('questionTitle')?'has-error':''}}">
                        ...
                        <div class="col-md-3">
                            <div class="form-group {{$errors->has('questionTitle')?'has-error':''}}">
                                ...
                                {!! Form::text('group_number',null,['class'=>'form-control','placeholder'=>'Group number']) !!}
                            </div>
                        </div>
